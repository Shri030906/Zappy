...
const bannedWords = [
  ...
  // Spanish examples (censored)
  "mierda",
  "joder",
  // French examples (censored)
  "merde",
  "putain",
  // German examples (censored)
  "scheiße",
  "verdammt",
  // Hindi examples (censored)
  ...
  // Add more inappropriate words from different languages here
];
